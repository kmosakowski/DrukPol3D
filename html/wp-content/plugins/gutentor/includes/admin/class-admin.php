    ...
    class Gutentor_Admin extends Gutentor_Helper {
    	...
    	public static function admin_pages(){
    	    ...
    	    add_menu_page( 
    	        ...
    	        'data:image/svg+xml;base64,' . base64_encode('<svg version="1.1" id="gray-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<rect x="4.154" y="19.683" fill="#9FA4A9" width="4.546" height="4.546"/>
        ...
        */
        ...
        public static function admin_editor_scripts() {
            ...
            $localize = array(
                'status' => Gutentor_Admin::block_action(),
            );
        ...
        public static function content(){
	        ...
	        $gutentor_block_collection = array(
		        ...
		        'divider'            => array(
			        ...
			        'description' => esc_html__( 'The Divider block is a simple block which helps user to differentiate between sections or other site elements with awesome shape and also allow to upload custom shape.', 'gutentor' ),
		        ),
