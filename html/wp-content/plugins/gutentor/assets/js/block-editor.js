(function( $ ) {
    ...
    gutentorDocument.on('click','.gutentor-sidebar-inspectors .gutentor-single-item-action-button',function(){
        var this_button = $(this),
            this_column = this_button.closest('.gutentor-column-inside'),
            this_edit_actions = this_column.children('.gutentor-single-item-edit-actions');
        ...
        setTimeout(function(){
            ...
            if( 'google' === gutentorFontType ){
                ...
                if( gutentorHead.children('#gutentor-google-'+uniqueID).length){
                    ...
                    gutentorHead.append($("<link/>", { rel: "stylesheet", href: url, type: "text/css", id: 'gutentor-google-'+uniqueID } ));
                }
            }
            }, 300);
    });
